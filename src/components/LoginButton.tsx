...
export default function LoginButton() {
  return (
    <button 
      ...
      className="group relative inline-flex h-14 items-center justify-center overflow-hidden rounded-full bg-neutral-950 px-8 font-medium text-neutral-200 border border-neutral-800 hover:border-indigo-500/50 transition-all duration-300 shadow-[0_0_0_0_rgba(99,102,241,0)] hover:shadow-[0_0_20px_0_rgba(99,102,241,0.3)]"
    >
